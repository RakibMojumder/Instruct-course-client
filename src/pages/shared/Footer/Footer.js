...
const Footer = () => {
    return (
        <div className='bg-gray-800 text-gray-100'>
            <footer className="w-[90%] lg:w-[1200px] mx-auto px-4 mt-40 divide-y">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3 hidden lg:block">
                        <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-bold text-[#0EA5E9]">InstructCOURSE</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3 text-[#0EA5E9]">
                ...
                <div className="py-6 text-sm text-center text-gray-400">© All rights reserved by <span className='text-[#0EA5E9]'>Rakib Ahmed</span>.</div>
            </footer>
        </div>
    );
};
