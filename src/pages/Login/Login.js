...
const Login = () => {
    ...
    return (
        <div className='grid grid-cols-12'>
            ...
            <div className="div col-span-10 md:col-span-8 lg:col-span-6 my-14 p-4 md:p-8 lg:p-16 border rounded-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-control mb-4">
                        <input className='text-slate-800 rounded-md focus:border-none' type="email" name='email' id='email' placeholder='Your Email' />
                    </div>
                    ...
                    <button type='submit' className='bg-[#7C53F5] rounded-md text-white w-full h-10'>Log in</button>
                </form>
